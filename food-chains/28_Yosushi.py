...
BASE_URL = "https://menus.tenkites.com/yosushi/allergenpageyosushi"
...
CANDIDATE_MENU_URLS = [
    ...
    # Also try the base tenant path which often serves the same menu by mguid
    lambda g: f"https://menus.tenkites.com/yosushi/yosushi?mguid={g}",
]
